...
import DrawerComponent from "../Navbar/DrawerComponent"; // Import your Drawer component
...
function Home({addToCart}) {
  ...
  return (
    <div>
            ...
            <div className="col-lg-8 col-xl-7 col-xxl-6">
              <div className="my-5 text-center text-xl-start">
                ...
                <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                  <a className="btn btn-dark btn-lg px-4 me-sm-3" href="#features">
                    Get Started
                  </a>
                </div>
              </div>
      ...
      <div className="container-fluid donate bg-dark my-5 py-5" data-parallax="scroll">
          ...
          <div className="row gx-5 align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <form>
                ...
                <div className="form-floating mb-3">
                  <textarea className="form-control" id="message" placeholder="Your Message" style={{ height: "10rem" }} required></textarea>
                  <label htmlFor="message">Message</label>
                </div>
                <button className="btn btn-dark btn-lg" type="submit">Send Message</button>
              </form>
            </div>
          </div>
        </div>
      ...
      {/* Drawer component */}
      <DrawerComponent isOpen={isDrawerOpen} cart={cart} onClose={toggleDrawer} />

      {/* Button to toggle drawer */}
      <button onClick={toggleDrawer} className="btn btn-primary position-fixed bottom-0 end-0 m-3">
        View Cart
      </button>
    </div>
  );
